  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <InputField placeholder='Nhập email bạn muốn đăng kí' icon={'email-outline'} onChangeText={text => setEmail(text)} />

        <InputField placeholder='Nhập mật khẩu ' icon={'lock-outline'} onChangeText={text => setPassword(text)} />

        <InputField placeholder='Xác thực lại mật khẩu' icon={'lock-outline'} onChangeText={text => setRePassword(text)} />
